...
void LAppView::Initialize()
{
    ...
    const auto window = LAppDelegate::GetInstance()->GetWindow();
    if (window != nullptr)
    {
...
{
    _programId = OpenGLShaderFactory::createShader();
    ...
    const string resourcesPath = ResourcesPath.getFullPathName().toStdString() + "/";
